    ...
    <div className='p-5 rounded-md shadow-md bg-white border border-gray-100'>
        ...
        <div className='flex items-center gap-2 my-2 '>
            <Button className= " p-0.5 w-10 h-10" variant="outline" size="icons">
                <Avatar>
                    <AvatarImage  src="https://imgs.search.brave.com/-0_GUEghkIIXQav20qq4pQBlz6-VZxmBqZRonfLhXS0/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly90NC5m/dGNkbi5uZXQvanBn/LzA0Lzg4LzA4Lzkz/LzM2MF9GXzQ4ODA4/OTM0NV9oR1FYTFYx/cmtnUWFNTUNGVXJj/cXlIQ0xMWEt3UnVm/eC5qcGc"></AvatarImage>
                </Avatar>
            </Button>
            <div>
